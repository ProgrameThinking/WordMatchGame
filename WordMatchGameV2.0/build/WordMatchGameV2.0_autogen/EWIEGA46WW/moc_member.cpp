...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Member_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Member_t qt_meta_stringdata_Member = {
    {
QT_MOC_LITERAL(0, 0, 6) // "Member"
...
QT_INIT_METAOBJECT const QMetaObject Member::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_Member.data,
    qt_meta_data_Member,
    qt_static_metacall,
    nullptr,
    nullptr
