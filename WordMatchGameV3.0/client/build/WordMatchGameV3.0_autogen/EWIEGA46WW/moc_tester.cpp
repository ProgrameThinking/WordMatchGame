...
QT_INIT_METAOBJECT const QMetaObject Tester::staticMetaObject = { {
    QMetaObject::SuperData::link<Member::staticMetaObject>(),
    qt_meta_stringdata_Tester.data,
    qt_meta_data_Tester,
    qt_static_metacall,
    nullptr,
    nullptr
...
void *Tester::qt_metacast(const char *_clname)
{
    ...
    return Member::qt_metacast(_clname);
}

int Tester::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = Member::qt_metacall(_c, _id, _a);
    return _id;
}
QT_WARNING_POP
